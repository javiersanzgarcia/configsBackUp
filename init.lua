...
require('packer').startup(function(use)
  ...
  use 'christoomey/vim-tmux-navigator' -- selector of panel with keyboard
  use 'benmills/vimux' -- Send info to antother panels
  use 'jiangmiao/auto-pairs' -- autoPair close
  use 'alvan/vim-closetag' -- auto close JSX tags
  use 'tpope/vim-surround' -- surround variables
  use 'eslint/eslint' -- Linter by default
  use 'tyewang/vimux-jest-test' -- plugin for Jest '<leader>T'
  use 'janko-m/vim-test' -- plugin for execute tests 
  use 'editorconfig/editorconfig-vim' -- editorconfig config to vim
  use 'terryma/vim-multiple-cursors' -- multiple cursors in VIM
  use 'easymotion/vim-easymotion' -- move to char <leader>s
